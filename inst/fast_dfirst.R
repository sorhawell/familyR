...
only_nodes=FALSE
allocateMemory=1E5
dfirst_rwrap = function(source_node,dt,max_depth=Inf,verbose=FALSE,only_nodes=FALSE,allocateMemory=1E5) {
  ...
  familyR::dfirst_test(1,dt$from,dt$to,TRUE,FALSE,seen_nodes_stream)
  return(list(
...
dfirst_test(1,dt,100,paths_stream,seen_nodes_stream)
